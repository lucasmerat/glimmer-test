...
<div class="mx-auto">
  ...
  <div class="flex justify-center flex-row w-full">
    <div class="w-full max-w-xs">
      <form class="bg-blue-dark shadow-md rounded px-8 pt-6 pb-8 mb-8">
        ...
        <p class="text-white italic my-4">
          A validation message
        </p>
        <div class="flex items-center justify-between">
          <input class="bg-gray-light text-gray-dark font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline"
